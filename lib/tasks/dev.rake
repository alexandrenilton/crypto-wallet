namespace :dev do
  ...
  task setup: :environment do
    if Rails.env.development?
      show_spinner("Apagando BD...") { %x(rails db:drop:_unsafe) }# Vai para o yield
    ...
    show_spinner("Cadastrando moedas...") do
      coins =  [
            ...
            { 
                ...
                acronym: "ETH",
                url_image: "https://www.logo.wine/a/logo/Ethereum/Ethereum-Icon-Purple-Logo.wine.svg",
                mining_type: MiningType.all.sample
            }, 
            { 
                description: "DogeCoin",
                acronym: "DOGE",
                url_image: "https://i1.wp.com/www.seekpng.com/png/detail/308-3087811_dogecoin-logo-png-transparent-dogecoin.png",
                mining_type: MiningType.all.sample
            }, 
            { 
  ...
  task add_mining_types: :environment do 
    show_spinner("Cadastrando tipos de mineração...") do
      ...
      [
        ...
        {description: "Brutal Force", acronym: "BF"}
      ]
